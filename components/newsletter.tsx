        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-md mx-auto bg-white rounded-lg p-8 shadow-lg">
            ...
            <p className="text-gray-600 mb-4">
              ...
              for exclusive offers and hair care tips!
            </p>
            <Button
              variant="outline"
      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Be the first to know about new arrivals, exclusive offers, and hair
          ...
          >
            ...
            <Button
              type="submit"
              className="bg-black text-white hover:bg-gray-800 px-8 py-2 font-semibold"
            >
              Subscribe
            </Button>
          </form>
