        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <span className="font-playfair text-2xl font-bold text-gradient">Muna Collection</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/shop" className="text-sm font-medium hover:text-amber-600 transition-colors">
                Shop
              </Link>
              ...
              <Link href="/faq" className="text-sm font-medium hover:text-amber-600 transition-colors">
                FAQ
              </Link>
            </nav>
            ...
            <div className="flex items-center space-x-2">
              <Button variant="ghost" size="icon" onClick={() => setIsSearchOpen(true)} className="hover:bg-amber-50">
