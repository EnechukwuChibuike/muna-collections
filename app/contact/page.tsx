    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 luxury-gradient">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-playfair text-5xl md:text-6xl font-bold mb-6 text-gray-900">Get in Touch</h1>
          <p className="text-xl text-gray-700 max-w-2xl mx-auto">
            We're here to help you find the perfect hair solution. Reach out to our expert team for personalized
          ...
          <div className="space-y-8">
            ...
            <Card className="border-0 shadow-lg bg-green-50">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600 mb-4">Get instant support and quick answers to your questions</p>
